...
], CambiarPasswordDto.prototype, "actual", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(8, { message: 'La nueva contraseña debe tener al menos 8 caracteres.' }),
    __metadata("design:type", String)
], CambiarPasswordDto.prototype, "nueva", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Confirma la nueva contraseña.' }),
    __metadata("design:type", String)
], CambiarPasswordDto.prototype, "confirmacion", void 0);
